...
It turns **Owliki** wiki exports and **GitBook** repositories into a fast, searchable,
...
# Helex terminology (optional) — FHIR server for {{csc:}}/{{vsc:}} and cs:/vs: links.
...
**Owliki layout.** An Owliki wiki export — or a hand-authored equivalent — is `space.json`
